...
namespace Quan_ly_nhan_su
{
    public partial class ChucNangPB : Form
    {
        ...
        {
            var model = from p in dt.PhongBans where p.active==true select p;
        ...
        private void bt_them_Click(object sender, EventArgs e)
        {
            ...
            {
                if(DataNhanSu.kiemtra("select dbo.testCodeOffice('" + tb_ma.Text+"')")==false)
                {
                    add();
        ...
        private void bt_xoa_Click(object sender, EventArgs e)
        {
            ...
            {
                DataNhanSu.sua("exec dbo.DeleteOffice N'" + tenluachon + "'");
