...
namespace Quan_ly_nhan_su
{
    public partial class Form1 : Form
    {
        ...
        private void biding()
        {
            ...
            dt_ngaysinh.DataBindings.Add(new Binding("Text", dataGridView1.DataSource, "Ngày sinh", true, DataSourceUpdateMode.Never));
