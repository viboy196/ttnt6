...
namespace QLDIEM
{
    public partial class frmDiemK2 : Form
    {
        string state;
        ...
        public void hienthi()
        {
            gridDiem.DataSource = KetNoiDB.Getdatatable("SELECT  MaMH, DMK2, D15K2, D45K21, D45K22, DTK2, DTBMK2 FROM  DiemKyII where MaHS='" + txtMaHS.Text + "'");
        }
        public frmDiemK2()
        {
            InitializeComponent();
        ...
        private void frmDiemK2_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if (state == "add")
                {
                    if (kiemtra() == 0)
                    {
                        KetNoiDB.ExcuteNonQR("INSERT INTO DiemKyII  (MaHS, MaMH, DMK2, D15K2, D45K21, D45K22, DTK2 , DTBMK2) VALUES  ('" + txtMaHS.Text + "','" + txtMaMH.Text + "','" + txtMieng.Text + "','" + txt15p.Text + "','" + txt1Tiet1.Text + "','" + txt1Tiet2.Text + "','" + txtThi.Text + "','"+TinhDiem()+"')");
                    }
                    else
                    {
            ...
            try
            {
                if (state == "update")
                {
                    KetNoiDB.ExcuteNonQR("UPDATE DiemKyII SET  DMK2 ='" + txtMieng.Text + "', D15K2 ='" + txt15p.Text + "', D45K21 ='" + txt1Tiet1.Text + "', D45K22 ='" + txt1Tiet2.Text + "', DTK2 ='" + txtThi.Text + "', DTBMK2='"+TinhDiem()+"' where MaMH='" + txtMaMH.Text + "'");
                }
            }
            catch
            {
            ...
            try
            {
                if (state == "delete")
                {
                    KetNoiDB.ExcuteNonQR("DELETE FROM DiemKyII where MaHS='" + txtMaHS.Text + "' and MaMH='" + txtMaMH.Text + "'");
                }
            }
            catch
            {
